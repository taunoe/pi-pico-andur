 ...
 * 
 * Copyright 2021-2025 Tauno Erik
 * https://taunoerik.art/
 */
...
void Tauno_Rotary_Encoder::begin() {
  pinMode(new_CLK_PIN, INPUT_PULLUP); //INPUT_PULLUP
 ...
 *   0 == DIR_NONE
 **/
int8_t Tauno_Rotary_Encoder::read() {
  /**
...
*/
  ...
  static uint32_t i = 0;
  Serial.print(i);Serial.print(" a "); Serial.println(new_a, BIN);
  Serial.print(i);Serial.print(" b "); Serial.println(new_b, BIN);
  i++;
